...
public static class DictionaryExtensions
{
    ...
    /// <summary>
    /// Appends given value if <paramref name="condition"/> is true and if value does not already exists.
    /// </summary>
    /// <param name="dictionary">Dictionary to check and get</param>
    /// <param name="key">Key to find the value</param>
    /// <param name="condition">Condition to statisfy.</param>
    /// <param name="factory">A factory method used to create the value if not found in the dictionary</param>
    /// <typeparam name="TKey">Type of the key</typeparam>
    /// <typeparam name="TValue">Type of the value</typeparam>
    /// <returns>Value if found, default if can not found.</returns>
    public static void AddIf<TKey, TValue>(this IDictionary<TKey, TValue> dictionary, bool condition, TKey key, Func<TValue> factory)
    {
        if (condition)
        {
            _ = dictionary.GetOrAdd(key, factory);
        }
    }
}
